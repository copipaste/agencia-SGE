...
public class UpdatePaqueteTuristicoInput {
    ...
    // Lista de IDs de servicios para actualizar las asociaciones del paquete
    private List<String> serviciosIds;

    // Constructors
    public UpdatePaqueteTuristicoInput() {
    }

    public UpdatePaqueteTuristicoInput(String nombrePaquete, String descripcion, String destinoPrincipal,
